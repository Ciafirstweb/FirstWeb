    ...
    <div style="width: 859px; float: left;">
        ...
        <table style="text-align: right; width: 750px">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCodigo" runat="server" Width="315px" TabIndex="2" type="number" Enabled="False"></asp:TextBox></td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblRazao" runat="server" Text="R. Social:"></asp:Label></td>
                <td colspan="4">
                    <asp:TextBox ID="txtRazao" runat="server" TabIndex="4" Width="630px" BackColor="#E6E6E6"></asp:TextBox></td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblFantasia" runat="server" Text="N. Fantasia:"></asp:Label></td>
                <td colspan="4">
                    <asp:TextBox ID="txtFantasia" runat="server" Width="630px" TabIndex="5" BackColor="#E6E6E6"></asp:TextBox></td>
            </tr>
        </table>
    </div>

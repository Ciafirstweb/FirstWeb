<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="gerenciar.aspx.vb" Inherits="FirstWeb.gerenciar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        ...
        <div class="principal" style="width: 17%">
            <table border="0">
                <tr>
                    <td><asp:ImageButton ID="imgCliente" runat="server" ImageUrl="~/images/icons/clientes.png" /></td>
